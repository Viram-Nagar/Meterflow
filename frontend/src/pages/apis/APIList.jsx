...
//             <span className="badge badge-gray">{api.category}</span>
//           </div>
//           <p className="text-xs font-mono text-surface-500 truncate mb-2">
//             {api.baseUrl}
//           </p>
//           {api.description && (
...
//       <div className="mt-3 pt-3 border-t border-surface-800/50">
//         <p className="text-xs text-surface-500 mb-1">Gateway URL</p>
//         <code className="text-xs font-mono text-brand-400 bg-brand-500/5 px-2 py-1 rounded border border-brand-500/10 block truncate">
//           {window.location.origin}/gateway/{api._id}/your-path
//         </code>
//       </div>
//     </div>
//   );
