...
//           color="emerald"
//           value={loadingOverview ? "—" : `${overview?.successRate || 100}%`}
//           sub={`${formatNumber(overview?.successRequests || 0)} successful`}
//         />
//         <StatCard
//           label="Active APIs"
//           icon={Boxes}
...
//           sub={
//             billing?.invoice
//               ? `Cycle ends ${formatDate(billing.invoice.periodEnd)}`
//               : "No charges yet"
//           }
//         />
//       </div>
...
//           </div>
//         ) : chartData.length === 0 ? (
//           <div className="h-48 flex flex-col items-center justify-center text-surface-500">
//             <Activity size={28} className="mb-2 opacity-40" />
//             <p className="text-sm">
//               No request data yet. Start making API calls.
//             </p>
//           </div>
//         ) : (
...
//               {
//                 label: "Avg Latency",
//                 value: overview ? `${overview.avgLatency}ms` : "—",
//               },
//               {
//                 label: "Min Latency",
//                 value: overview ? `${overview.minLatency}ms` : "—",
//               },
//               {
//                 label: "Max Latency",
//                 value: overview ? `${overview.maxLatency}ms` : "—",
//               },
//               {
//                 label: "Error Rate",
...
//                 <span
//                   className={`text-sm font-medium font-mono ${warn ? "text-red-400" : "text-surface-200"}`}
//                 >
//                   {value}
//                 </span>
//               </div>
...
//                   <span className="text-sm text-surface-400">{label}</span>
//                   <span
//                     className={`text-sm font-medium ${highlight ? "text-brand-400 font-mono" : "text-surface-200"}`}
//                   >
//                     {value}
//                   </span>
//                 </div>
