 ...
 * @description Mock payment controller endpoints.
 *
 * POST /api/v1/payments/order/plan     → Create plan upgrade order
 * POST /api/v1/payments/order/invoice  → Create invoice order
