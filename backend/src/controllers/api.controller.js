...
//  * @description Handles API management — CRUD for APIs and API Keys.
//  *
//  * API Operations:
//  *   createAPI     → Register a new API
//  *   getMyAPIs     → List owner's APIs
//  *   getAPI        → Get single API details
//  *   updateAPI     → Update API config
//  *   deleteAPI     → Delete API (soft)
//  *   toggleStatus  → Activate / deactivate
//  *
//  * Key Operations:
//  *   generateKey   → Create new API key
//  *   getKeys       → List keys for an API
//  *   getKey        → Get single key details
//  *   revokeKey     → Revoke a key
//  *   rotateKey     → Revoke old + generate new key
//  */
