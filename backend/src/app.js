 ...
 * All middleware, security, routes configured here.
 * Server startup (listen) is in server.js — separation of concerns.
 */
...
// // Example: app.use(`/api/${env.API_VERSION}/auth`, authRoutes);
